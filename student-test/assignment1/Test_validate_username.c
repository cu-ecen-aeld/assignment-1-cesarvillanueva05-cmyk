...
{   
    const char *hrd_username = my_username();
    char *submod_username = malloc_username_from_conf_file();
    
    TEST_ASSERT_TRUE_MESSAGE(hrd_username, submod_username);

    free(submod_username);
